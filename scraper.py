...
async def realizar_login_playwright(p):
    """Realiza el login usando Playwright (recibe el objeto playwright ya iniciado)"""
    ...
    # PASO 8: Recargar la página principal y continuar
...
async def main():
    ...
    async with async_playwright() as p:
        # Realizar login (pasando el objeto playwright)
        result = await realizar_login_playwright(p)
